                        ...
                        <form action="change-information" method="post">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" class="form-control" id="inputEmail4" placeholder="Email" required="" value="${user.email}" name="email">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputUsername4" style="font-weight: bold">Username: </label>
                                    <input type="text" class="form-control" id="inputUsername4" placeholder="Username" required="" value="${user.username}" name="username">
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="inputPassword4" required="" placeholder="Password" value="${user.password}" name="password">
                                </div>
                                <div class="form-group col-md-4">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="address" required="" placeholder="Adderss" value="${user.address}" name="address">
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlFile1" style="font-weight: bold">Image</label>
                                    <input type="file" class="form-control-file" required="" accept="image/*" onchange="loadFile(event)" id="exampleFormControlFile1" name="image">
