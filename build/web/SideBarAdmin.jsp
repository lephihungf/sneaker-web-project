    <div class="d-flex flex-column flex-shrink-0 p-3 text-white"  style="height: 100vh; width: 250px; background-color: #59ab6e">
                    ...
                    <ul class="list-unstyled templatemo-accordion">
                        ...
                        <ul class="collapse show list-unstyled pl-3">
                            ...
                            <li>
                                <a href="list-order" class="nav-link sidebarBtn" style="color: white">
                                    <i class="fa-solid fa-cart-plus pe-3" style="margin-right: 10px"></i>                            
                                    Orders
                                </a>
                            </li>
                            <li>
                                <a href="list-product" class="nav-link sidebarBtn" style="color: white">
                                    <i class="fa-brands fa-product-hunt pe-3" style="margin-right: 10px"></i>
                                    Products
                                </a>
                            </li>
                            <li>
                                <a href="list-user" class="nav-link sidebarBtn" style="color: white">
